...
type Logger interface {
	...
	// FatalfIf FatalCtx if error and print error message uses fmt.Sprintf to log a template message with extra context value, then calls os.Exit
	FatalfIf(cond bool, fmt string, args ...interface{})
